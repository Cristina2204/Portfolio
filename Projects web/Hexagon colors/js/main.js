...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>Cum jucam?</div><p>Scopul jocului este de a impediaca blocurile sa paraseasca interiorul hexagonului gri exterior.</p><p>" + (settings.platform != 'mobile' ? 'Apasati tastele sageata dreapta si stanga' : 'Atingeti partea stanga si cea dreapta a ecranului') + " pentru a roti hexagonul." + (settings.platform != 'mobile' ? ' Apasati sageata in jos pentru a accelera blocarea blocului': '') + " </p><p>Blocati blocurile si obtineti puncte, facand 3 sau mai multe blocuri de aceeasi culoare atingeti.</p><p>Timpul ramas inainte de disparitia benzii combo este indicat de <span style='color:#f1c40f;'></span> <span style='color:#e74c3c'>Linii</span> <span style='color:#3498db'>colorate</span> <span style='color:#2ecc71'>pe</span> exteriorul hexagonului</p> <hr> <p id = 'afterhr'></p>  ");
	if (gameState == 1) {
		pause();
	}
