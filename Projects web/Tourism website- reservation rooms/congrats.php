...
<head>
  ...
  <title>Felicitari! - Take me anyware</title>
...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
            ...
            <ul class="nav navbar-nav menu_nav justify-content-end">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="about.php">Despre</a></li> 
  ...
  <section class="hero-banner congrats-bg">
    <div class="container">

      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-6 col-lg-5 mb-5">
          <h1 class="text-white" style="text-shadow: 2px 2px 5px #000000ff">Felicitari!</h1>
          <p class="text-white"  style="text-shadow: 2px 2px 5px #000000ff">Esti mai aprope de vacanta mult dorita!<br/>Verifica detaliile rezervarii pe email.</p>
        </div>
      </div>
    </div>
  </section>
